    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btn_next.setOnClickListener {
            ...
            if (isAllAnswered) {
                ...
                (activity as? TestActivity)?.questionnaireResults?.addResponses(responses) // questionnaireResults에 응답을 저장
                (activity as? TestActivity)?.moveToNextQuestion() // 다음 질문으로 이동
